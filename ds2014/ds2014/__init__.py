...
brca_size_factors = join(subdir, 'brca_size_factors.tsv')
cll_size_factors = join(subdir, 'cll_size_factors.tsv')
um_size_factors = join(subdir, 'um_size_factors.tsv')
brca_cll_um_size_factors = join(subdir, 'brca_cll_um_size_factors.tsv')
brca_cll_luad_lusc_um_size_factors = join(subdir, 'brca_cll_luad_lusc_um_size_factors.tsv')
